<?php
	/** 
	* $Id: comments.php,v 1.1.1.1 2005/06/05 21:58:35 templis Exp $
	* vim: set tabstop=4:
	*
	...
	* define module title
	*/
	$module_title .= ' <span style="font-size:8px;">::</span> kommentare';
		...
		if(preg_match('/^[a-fA-F\d]{10}$/', $_REQUEST['id'])) {
			...
			*/
			...
			if($newsbeitrag = mysql_fetch_assoc($result)) {
				...
				*/
				$comments_link = append_sid(RELATIVE_PATH . '/index.php?module=news&amp;section=comments&amp;id=' . $newsbeitrag['cryptid']);
