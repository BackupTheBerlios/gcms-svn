<?php
	...
	* define module title
	*/
	$module_title = ' <span class="titleseperator">' . $GCMS['CONFIG']['title_separator'] . '</span> ' . $GCMS['LANG']['IMPRINT']['imprint'];
	...
	*/
	$GCMS['TEMPLATE']->set_filenames(array(
		'imprint_index' => 'imprint/index.tpl'
	));
	...
	*/
	...
	/**                                                                                              
	* parse imprint template    
	*/
	$GCMS['TEMPLATE']->pparse('imprint_index');
?>
