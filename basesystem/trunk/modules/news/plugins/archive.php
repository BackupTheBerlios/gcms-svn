<?php
    ...
    * define module title
    */
    $module_title .= ' <span class="titleseperator">' . $GCMS['CONFIG']['title_separator'] . '</span> ' . $GCMS['LANG']['NEWS']['archive'];
	...
	* parse rss template    
	*/
	$GCMS['TEMPLATE']->pparse('news_archive');
?>
