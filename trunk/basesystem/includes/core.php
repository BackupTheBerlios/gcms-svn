<?php
	...
	*/
	...
	require_once(GCMS_REAL_PATH . '/libaries/base_functions.php');
    require_once(GCMS_REAL_PATH . '/libaries/user_functions.php');
    require_once(GCMS_REAL_PATH . '/libaries/bbcode_functions.php');
