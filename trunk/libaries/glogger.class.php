<?php
    ...
    * include exception
    */
    require_once(LIB_PATH . 'exceptions/glogger_exception.class.php');


    /**
    * this class handles as base class for everything related to log data
    *
    * @access  public
    * @author  GDev Team <devel@ghcif.de>
    * @since   23/08/2005
        ...
        */
        public static function get_instance() {
            if(self::instance != null) {
                ...
                throw new glogger_exception('Call factory method first time');
            }
        }
